  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center px-4">
      ...
      >
        ...
        <motion.div {...fadeUp} className="mt-4">
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center">
              <span className="bg-bg px-3 text-xs text-txt-muted">or</span>
            </div>
          </div>
          <button
            type="button"
            onClick={() => signIn("google", { callbackUrl: "/dashboard" })}
            className="flex w-full items-center justify-center gap-2 rounded-2xl border border-white/10 bg-surface/50 px-4 py-3 text-sm font-medium text-txt transition-colors hover:bg-surface"
          >
        ...
        <motion.div {...fadeUp} className="mt-4 glass-card !p-3 text-center text-xs text-txt-dim">
          <p className="font-semibold text-txt-muted">Try it out</p>
          <p className="mt-0.5">alice@example.com · bob@example.com · carol@example.com</p>
