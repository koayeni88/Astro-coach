...
export default function RegisterPage() {
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center px-4">
      <div className="pointer-events-none absolute -top-20 left-1/2 h-64 w-64 -translate-x-1/2 rounded-full bg-astro-teal/6 blur-[100px]" />
      ...
      >
        <motion.div {...fadeUp} className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-txt">Create Your Account</h1>
